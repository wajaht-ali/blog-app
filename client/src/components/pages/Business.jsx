...
const Business = () => {
  ...
  return (
    <div className='h-screen w-full flex flex-col mx-auto px-4 my-3'>
      <div className="py-3">
        <h2 className='border-l-4 rounded-sm border-[#FFD230] text-lg md:text-xl font-bold px-2'>Business</h2>
      </div>
